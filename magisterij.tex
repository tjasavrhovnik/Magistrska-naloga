...
%
Drugi razlog za študij konformnih imerzij je fizikalen. Na minimalne ploskve lahko gledamo kot na rešitve Plateaujevega problema, katerega moramo najprej natančno formulirati. Razdelek je povzet po~\cite[str.~56]{lawson1980lectures} in~\cite[Section~6.3]{forstneric2021minimal}.
...
J.~Douglas in T.~Rad\'o sta l.~1932 dokazala, da vsaka Jordanova krivulja v $\mathbb{R}^3$ določa minimalno ploskev (\cite[Theorem~7]{lawson1980lectures}). % citiraj [Lawson, Theorem 7]
...
ki pravi, da za poljubno Jordanovo krivuljo $\Gamma$ v $\R^{n}$ obstaja enostavno povezana posplošena minimalna ploskev z robom $\Gamma$~\cite[Theorem~7.1]{osserman2002survey}. 
...
Izrek A.~Huberja~\cite[Theorem~2.6.4]{alarcon2021minimal} % citiraj [Theorem 2.6.4]
...
minimalne ploskve sta l.~1967 dokazala S.~S.~Chern in R.~Osserman~\cite[Theorem~2.6.7]{alarcon2021minimal}. % citiraj [Theorem 2.6.7]
...
\begin{opomba}
Izkaže se, da je % citiraj [Theorem 5.4.1]
vsaka holomorfna preslikava $M \to \mathbb{CP}^1$ kompleksna Gaussova preslikava neke konformne minimalne imerzije $M \to \R^3$~\cite[Theorem~5.4.1]{alarcon2021minimal}, kar pomeni, da je vsako celo število z intervala $[-\infty, 0]$ vrednost totalne Gaussove ukrivljenosti neke minimalne ploskve v prostoru $\R^3$.
\end{opomba}
...
Znano je (\cite[Section~2.4]{alarcon2021minimal}), da je vsaka neorientabilna minimalna ploskev $S$, ki nastane z imerzijo v prostor $\R^{n}$, slika 2-listne konformne minimalne imerzije $x \colon M \to S \subset \R^{n}$, kjer je $M$ Riemannova ploskev. % citiraj [Section 2.4]
...
\end{gather}
Obratne implikacije ne vejajo (~\cite[Lemma~12.4]{osserman2002survey}).
...
Za iskanje bližnjih preslikav tistih, ki nastopajo v periodno dominantnem spreju, se bomo sklicali na različice Izrekov~\ref{izr:Runge},~\ref{izr:Bishop-Mergelyan} in~\ref{izr:Weierstrass-Florack}, tokrat za preslikave v (Oka) mnogoterosti~\cite[Theorem~1.13.1,~1.13.3]{alarcon2021minimal}, %(citiraj izreka 1.13.1, 1.13.3)
ter preslikave, definirane na dopustnih množicah~\cite[Theorem~1.12.11]{alarcon2021minimal}. %(citiraj izrek 1.12.11)
...
Sklicujemo se na izrek o splošni legi za kompaktne omejene Riemannove ploskve~\cite[Theorem~3.4.1]{alarcon2021minimal}, % citiraj Theorem 3.4.1
...
Izrek~\cite[Theorem~3.4.1~(b),(c)]{alarcon2021minimal} % citiraj Theorem 3.4.1 - (b,c)
...
Pogoja~\textit{(iv)},~\textit{(v)} sledita iz Izreka~\cite[Theorem~3.4.1]{alarcon2021minimal}. % citiraj Theorem 3.4.1
...
Po prvem delu dodatka k Izreku~\cite[Theorem~3.4.1]{alarcon2021minimal} % citiraj Theorem 3.4.1
...
Sedaj uporabimo Trditev~\ref{trd:nekritcni-primer} in Izrek~\cite[Theorem~3.4.1]{alarcon2021minimal}, % citiraj izrek 3.4.1
...
Spet uporabimo Trditev~\ref{trd:nekritcni-primer} in Izrek~\cite[Theorem~3.4.1]{alarcon2021minimal}, % citiraj izrek 3.4.1
...
Nato kot prej preslikavo $x^{i-1}$ razširimo na množico $S_{i}$, dobimo posplošeno konformno minimalno imerzijo $(x^{i-1}, f^{i-1} \theta)$, uporabimo Trditev~\ref{trd:nekritcni-primer} in Izrek ~\cite[Theorem~3.4.1]{alarcon2021minimal}, % citiraj izrek 3.4.1
...
%%%%% dokaz leme
\begin{dokaz}
Sledimo dokazu~\cite[Theorem~3.1]{alarcon2019algebraic}.
...
Dokaz različice izreka se nahaja v~\cite[Theorem~7.1]{alarcon2019algebraic}. % CITIRAJ [1906.01915.pdf: Theorem 7.1, dokaz]
