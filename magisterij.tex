...
\end{gather} 
imenujemo \emph{totalna Gaussova ukrivljenost}.
...
\begin{enumerate}
	...
	\item Za parcialna odvoda $\frac{\partial x}{\partial u} = x_{u}$ in $\frac{\partial x}{\partial v} = x_{v}$ velja
		...
		\end{gather*}
	\item Vektorji $x_{u} \pm ix_{v} \in \mathbb{C}_{*}^{n}$ pripadajo \emph{ničelni kvadriki} (so \emph{ničelni vektorji})
		\begin{gather*}
...
%%%%%%%%%%%%%%%
% Plateajev problem in Dirichletov energijski integral [VIR: Lawson 2.1, Minimal srfaces for undergraduates 6.3]
