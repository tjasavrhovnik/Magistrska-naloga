...
% Lema: Co(A)=C^n
\begin{lema}
Konveksna ogrinjača\index{konveksna ogrinjača} ničelne kvadrike $\textup{\textbf{A}} \subset \C^{n}$ je ves $\C^{n}$, tj.~$\mathrm{Co}(\textup{\textbf{A}}) = \C^{n}$.
\end{lema}
