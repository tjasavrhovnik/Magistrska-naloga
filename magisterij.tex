...
% Lema: Con(A)=C^n
\begin{lema}
Konveksna ogrinjača ničelne kvadrike $\textup{\textbf{A}} \subset \C^{n}$ je ves $\C^{n}$, tj.~$\mathrm{Con}(\textup{\textbf{A}}) = \C^{n}$.
\end{lema}

\begin{dokaz}
Označimo s $\Sigma \subseteq \C^{n}$ $\C$-linearno ogrinjačo ničelne kvadrike $\textup{\textbf{A}}$ in dokažimo, da je $\mathrm{Con}(\textup{\textbf{A}}) = \Sigma$. \newline
Očitno je $\mathrm{Con}(\textup{\textbf{A}}) \subseteq \Sigma$. \newline
...
\end{gather*}
torej je $v \in \mathrm{Con}(\textup{\textbf{A}})$ in $\Sigma \subseteq \mathrm{Con}(\textup{\textbf{A}})$.
