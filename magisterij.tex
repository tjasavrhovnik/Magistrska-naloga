...
Drugi pomemben rezultat Meusnierja, ki prav tako izhaja iz variacijske formule, je ugotovitev, da ploskve z ničelno povprečno ukrivljenostjo minimizirajo površino. Ta lastnost predstavlja eno izmed karakterizacij minimalnih ploskev.
...
Plateaujev problem, katerega začetki segajo vse do Lagrangea, sta leta 1932 neodvisno rešila ameriški matematik Jesse Douglas in madžarski matematik Tibor Rad\'o. Dokaza, ki temeljita na variacijskem računu, sta povsem različna, Douglas pa je bil za svoj uspeh in vpeljavo novih idej l.~1936 nagrajen s Fieldsovo medaljo, najprestižnejšo nagrado za matematične dosežke. Rezultat, ki potrjuje Plateaujevo domnevo, a dokaže le obstoj minimalne ploskve, je odprl številna vprašanja. 
Pomembna poglavja o temi so postale (ne)orientabilne, kompletne in prave minimalne ploskve, ploskve v Neevklidskih prostorih in Riemannovih mnogoterostih, tiste s končno totalno Gaussovo ukrivljenostjo, ploskve s konstantno (ne nujno ničelno) povprečno ukrivljenostjo.
Velik prispevek k razumevanju teorije minimalnih ploskev pripada Robertu Ossermanu, ki je v sredini 20.~stoletja predstavil več pomembnih rezultatov, ta pa so vodila v obravnavo globalne teorije minimalnih ploskev z metodami kompleksne analize.
...
%
% VIR: zgodovina po [Holomorphic approximation: the legacy ...]
...
%%%%%%%%%%%%%%%
% Plateajev problem in Dirichletov energijski integral [VIR: Lawson 2.1, p. 56; Minimal surfaces for undergraduates 6.3]
...
J.~Douglas in T.~Rad\'o sta l.~1932 dokazala, da vsaka Jordanova krivulja v $\mathbb{R}^3$ določa minimalno ploskev. % citiraj [Lawson, Theorem 7]
...
\begin{opomba} % citiraj [Osserman: Theorem 7.1 & Remarks, Appendix 3 (p. 143)]
Fundamentalni rezultat o obstoju minimalnih ploskev s predpisanim robom je izrek, % citiraj [Osserman, Theorem 7.1]
ki pravi, da za poljubno Jordanovo krivuljo $\Gamma$ v $\R^{n}$ obstaja enostavno povezana posplošena minimalna ploskev z robom $\Gamma$. 
...
% 
V prejšnjem razdelku smo navedli prvo variacijo površine v splošnem primeru. Kadar je imerzija konformna, se z upoštevanjem Leme~\ref{lema:Area<=D/2} in zgornjih opažanj izpeljava precej poenostavi. 
...
%%%%%%%%%%%%%%%
% Totalna Gaussova ukrivljenost [Chapter 2.6 & Undergraduates p. 20]
...
Izrek A.~Huberja [...] % citiraj [Theorem 2.6.4]
pove: če je $(M,g)$ kompletna orientabilna Riemannova ploskev in $\int_{M} K^{-}dA > -\infty$, potem je $M$ konformno ekvivalentna komplementu končno mnogo točk v kompaktni Riemannovi ploskvi. \newline
...
minimalne ploskve sta l.~1967 dokazala S.~S.~Chern in R.~Osserman [...]. % citiraj [Theorem 2.6.7]
...
\begin{opomba}
Znano je [...], % citiraj [Theorem 5.4.1]
da je vsaka holomorfna preslikava $M \to \mathbb{CP}^1$ kompleksna Gaussova preslikava neke konformne minimalne imerzije $M \to \R^3$, kar pomeni, da je vsako celo število z intervala $[-\infty, 0]$ vrednost totalne Gaussove ukrivljenosti neke minimalne ploskve v prostoru $\R^3$.
\end{opomba}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.8]{images/enneper-surface.pdf}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.8]{images/henneberg-surface.pdf}
\caption{Hennebergova ploskev je prva odkrita neorientabilna minimalna ploskev.}
\end{center}
\end{figure}

Znano je, da je vsaka neorientabilna minimalna ploskev $S$, ki nastane z imerzijo v prostor $\R^{n}$, slika 2-listne konformne minimalne imerzije $x \colon M \to S \subset \R^{n}$, kjer je $M$ Riemannova ploskev. % citiraj [Section 2.4]
...
Druga pomembna stvar pa so dopustne množice.
...
% Zadnji del - CITIRAJ [1701.04379.pdf, Lemma 2.2]
...
Navedli bomo le osnovne ideje dokaza leme. Popoln dokaz, ki se nahaja v [...], posnema dokaz leme Mikhaila Gromova o konveksni integraciji.
...
% CITIRAJ: povzeto po Chapter 1.4, p. 20--22
...
Sklicujemo se na izrek o splošni legi za kompaktne omejene Riemannove ploskve [...], % citiraj Theorem 3.4.1
...
Izrek [...] % citiraj Theorem 3.4.1 - (b,c)
...
Pogoja~\textit{(iv)},~\textit{(v)} sledita iz Izreka [...]. % citiraj Theorem 3.4.1
...
Po prvem delu dodatka k Izreku [...] % citiraj Theorem 3.4.1
...
Sedaj uporabimo Trditev~\ref{trd:nekritcni-primer} in Izrek [...], % citiraj izrek 3.4.1
...
Spet uporabimo Trditev~\ref{trd:nekritcni-primer} in Izrek [...], % citiraj izrek 3.4.1
...
Nato kot prej preslikavo $x^{i-1}$ razširimo na množico $S_{i}$, dobimo posplošeno konformno minimalno imerzijo $(x^{i-1}, f^{i-1} \theta)$, uporabimo Trditev~\ref{trd:nekritcni-primer} in Izrek [...], % citiraj izrek 3.4.1
...
% CITIRAJ [1906.01915.pdf: Theorem 3.1, dokaz]
%%%%% dokaz leme
\begin{dokaz}
...
Dokaz različice izreka se nahaja v~[...]. % CITIRAJ [1906.01915.pdf: Theorem 7.1, dokaz]
