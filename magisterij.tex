...
\end{align}
Iz zadnje preberemo njeno Gaussovo preslikavo $\mathfrak{g}(\zeta) = e^{i\zeta}$.
...
\end{align}
pravimo \emph{katenoida}. Po drugi strani do konformne parametrizacije katenoide pridemo preko pridruženih minimalnih ploskev k izbrani holomorfni ničelni krivulji -- katenoida ustreza parametrom $t = k \pi, \ k \in \mathbb{Z}$.

Geometrijsko je katenoida rotacijska ploskev, ki nastane z rotacijo grafa hiperboličnega kosinusa (t.~i.~\emph{verižnice}) okoli izbrane osi v prostoru $\mathbb{R}^3$. Katenoida z osjo rotacije $x=y=0$ na primer nastane, če graf krivulje $z \mapsto (\cosh z, 0, z), \ z \in \mathbb{R}$, zavrtimo okrog $z$-osi. Implicitna enačba nastale minimalne ploskve se glasi
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.8]{catenoid.pdf}
