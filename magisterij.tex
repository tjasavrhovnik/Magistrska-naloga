...
\[ \textup{GCMI}_{full}^{r}(S, \R^{n}) \subset \textup{GCMI}{nf}^{r}(S, \R^{n}) \subset \textup{GCMI}^{r}(S, \R^{n}). \]
...
\[ \textup{GNC}_{full}^{r}(S, \C^{n}) \subset \textup{GNC}{nf}^{r}(S, \C^{n}) \subset \textup{GNC}^{r}(S, \C^{n}). \]
