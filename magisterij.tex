...
%
Spomnimo se, da je imerzija $x \colon M \to \R^{n}$ \emph{kompletna}, če ima vsaka pot $x \circ \gamma$ v $\R^{n}$ neskončno Evklidsko dolžino za vsako divergentno pot $\gamma \colon [0,1) \to M$.
...
\end{gather*}
za katere velja $U \cap M_{0} = \emptyset$ in $U \cap bM_{i} = \emptyset$ za $i = 1,2,\dots$ To zaporedje množic $M_{i}$ igra pomembno vlogo v dokazu izreka, ki poteka z indukcijo, podobno kot dokaz glavnega izreka iz prejšnjega poglavja.
