...
% Lema: Con(A)=C^n
\begin{lema}
Konveksna ogrinjača ničelne kvadrike $\textup{\textbf{A}} \subset \C^{n}$ je ves $\C^{n}$, $Con(\textup{\textbf{A}}) = \C^{n}$.
\end{lema}

\begin{dokaz}
Označimo s $\Sigma \subseteq \C^{n}$ $\C$-linearno ogrinjačo ničelne kvadrike $\textup{\textbf{A}}$ in dokažimo, da je $Con(\textup{\textbf{A}}) = \Sigma = Lin(A)$. \newline
