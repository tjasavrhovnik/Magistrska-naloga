...
Obravnava minimalnih ploskev ima bogato zgodovino, saj so le-te zaradi geometrijskih in fizikalnih lastnosti ter nenazadnje vizualnega izgleda že pred več stoletji pritegnile pozornost radovednih.

Začetke študija teme lahko postavimo v leto 1744, ko je švicarski matematik Leonhard Euler opisal katenoido kot edino rotacijsko ploskev v prostoru $\R^3$ poleg ravnine. To ploskev dobimo z rotacijo verižnice, ki jo predstavlja graf hiperboličnega kosinusa $y = \cosh(x) \subset \R^2$, okoli abscisne osi v trirazsežnem Evklidskem prostoru $\R^3$. Verižnica je že sama po sebi zanimiva krivulja, saj posnema obliko vrvi, pripete v obeh koncih, na katero vpliva le lastna masa.

Slabi dve desetletji kasneje je Joseph-Louis Lagrange z razvojem variacijskega računa napravil pomemben korak v razumevanju minimalnih ploskev. Leta 1760 je postavil naslednji problem: iščemo ploskve z najmanjšo površino, ki so omejene z danim robom. Vprašanje poznamo kot Plateaujev problem, imenovan po belgijskemu fiziku in matematiku Josephu Plateauju, ki je eksperimentiral z milnimi mehurčki. 
S pomočjo variacijske metode je Lagrange poskušal najti stacionarne točke ploskovnega funkcionala in izpeljal enačbo za minimalne grafe, objavljeno l.~1762. S tem smo dobli tudi novo definicijo minimalne ploskve kot stacionarne točke ploskovnega funkcionala.
...
Drugi pomemben rezultat Meusnierja je ugotovitev, da ploskve z ničelno povprečno ukrivljenostjo minimizirajo površino. Ta lastnost predstavlja eno izmed karakterizacij minimalnih ploskev.
