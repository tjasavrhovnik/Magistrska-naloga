...
%
Ekvivalnetnost prvih dveh trditev smo zapisali v Izreku~\ref{izr:min-ekviv-H=0}.\newline 
%
Ekvivalentnost druge in tretje trditve povzema Lema~\ref{lema:laplace=2H}.\newline
%
...
\end{align*}
ki je enakost~\ref{eq:partialx^2 = 0}. Ker velja $dd^{c}x = -2i \bar{\partial} (\partial x)$, je $x$ harmonična natanko tedaj, ko je $\partial x$ holomorfna, kar je ekvivalenca tretje in četrte trditve.\newline
%
Očitno sta četrta in peta trditev ekvivalentni.\newline
%
