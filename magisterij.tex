...
\begin{align*}
\frac{d}{dt} \Big|_{t=0} \text{Area}(x^{t}(M)) &= -2 \cdot \int_{M} E \cdot \textbf{\textup{H}} dA = -2 \cdot \int_{M} f \textbf{\textup{H}} \cdot \textbf{\textup{H}} dA \\
...
Podobno pravimo, da je lokalna karta $(U, \phi)$ Riemannove ploskve $(M,g)$ \emph{izotermna} glede na Riemannovo metriko $g$, če za neko pozitivno funkcijo $\mu \colon \phi(U) \subset \mathbb{R}_{(x,y)}^2 \to \mathbb{R}_{+}$ velja
\begin{gather}
