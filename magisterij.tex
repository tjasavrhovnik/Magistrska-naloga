...
Pravost preslikav je strožja zahteva od kompletnosti, zato moramo pri aproksimaciji in interpolaciji s takimi preslikavami postaviti dodatne pogoje. Natančneje, potrebna je pravost preslikav na interpolacijski množici $\Lambda \subset M$ (\cite[Theorem~3.10.1]{alarcon2021minimal}).
...
Oglejmo si nekaj posledic zgornjega rezultata.
